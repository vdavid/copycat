...
export class AppMenu {
    constructor(context, buttons, canvasWidth, canvasHeight, levelCount, lastUnlockedLevelIndex, spriteService, audioService) {
        ...
        this._mainMenu = new MainMenu(context, canvasWidth, canvasHeight, canvasWidth / 2, 110, menuItems, audioService, spriteService);
    }
    ...
    _renderLevelsMenu() {
        ...
        this._spriteService.drawFrame(10, 10, this._canvasWidth - 20, 200 - 20, "#fff1e8");
        this._spriteService.write("select level", this._canvasWidth / 2, 25);
        ...
        this._context.fillRect(0, this._canvasHeight - 35, this._canvasWidth, 28);
        this._spriteService.write("arrow keys to select 'x' to confirm", this._canvasWidth / 2, this._canvasHeight - 30);
        this._spriteService.write("press 'c' to return to menu", this._canvasWidth / 2, this._canvasHeight - 20);
    }

    _renderRules() {
        this._clearScreen("#fff1e8");

        this._spriteService.write("game control: ", this._canvasWidth / 2, 15);
        this._spriteService.write("arrow keys to move", this._canvasWidth / 2, 60);
        this._spriteService.write("'f' to toggle fullscreen", this._canvasWidth / 2, 80);
        this._spriteService.write("'r' if you're stuck", this._canvasWidth / 2, 100);
        this._spriteService.write("'e' to exit the game", this._canvasWidth / 2, 120);
        this._context.fillStyle = "#83769c";
        this._context.fillRect(0, this._canvasHeight - 35, this._canvasWidth, 18);
        this._spriteService.write("press 'c' to return to menu", this._canvasWidth / 2, this._canvasHeight - 30);
    }

    _renderAbout() {
        this._clearScreen("#fff1e8");

        this._spriteService.write("about: ", this._canvasWidth / 2, 15);
        this._spriteService.write("made with html5 canvas", this._canvasWidth / 2, 40);
        this._spriteService.write("by gtibo on codepen", this._canvasWidth / 2, 55);
        this._spriteService.write("credits:", this._canvasWidth / 2, 80);
        this._spriteService.write("sound effects: noiseforfun.com", this._canvasWidth / 2, 100);
        this._context.fillStyle = "#83769c";
        this._context.fillRect(0, this._canvasHeight - 35, this._canvasWidth, 18);
        this._spriteService.write("press 'c' to return to menu", this._canvasWidth / 2, this._canvasHeight - 30);
    }
    ...
    _renderFinishedLastLevelScreen() {
        ...
        this._spriteService.write("thanks for playing :) !", this._canvasWidth / 2, 15);
        this._spriteService.write("if you have something to tell me about", this._canvasWidth / 2, 40);
        this._spriteService.write("this pen please do so", this._canvasWidth / 2, 55);
        this._spriteService.write("in the comment section.", this._canvasWidth / 2, 70);
        this._spriteService.write("any feedback is appreciated", this._canvasWidth / 2, 85);
        this._context.fillStyle = "#83769c";
        this._context.fillRect(0, this._canvasHeight - 35, this._canvasWidth, 18);
        this._spriteService.write("press 'c' to return to menu", this._canvasWidth / 2, this._canvasHeight - 30);
    }
